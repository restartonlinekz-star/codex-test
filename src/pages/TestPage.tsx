...
import { Clock, ChevronLeft, ChevronRight, Flag, CheckCircle, XCircle, AlertCircle } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen flex items-center justify-center pt-20">
        <div className="text-center">
          ...
          <p className="font-mono text-codex-muted mb-6">Сұралған тест жоқ немесе жойылған</p>
          <button 
